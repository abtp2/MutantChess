...
export function ChessPiece({ type, color, className = "w-full h-full select-none pointer-events-none drop-shadow-md" }) {
  ...
  switch (type) {
    ...
    case 'n':
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    case 'b':
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeLinecap="butt">
            ...
            <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,10 L 22.5,14 M 20.5,12 L 24.5,12" stroke={isWhite ? "#111111" : "#ffffff"} strokeWidth="1.2" />
          </g>
        </svg>
      );
    case 'r':
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M 14,17 L 31,17" stroke={isWhite ? "#111" : "#eee"} strokeWidth="1" />
          </g>
        </svg>
      );
    case 'q':
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M 9,26 C 17.5,24.5 27.5,24.5 36,26" fill="none" stroke={isWhite ? "#111" : "#fff"} strokeWidth="1.2" />
    ...
    case 'k':
      return (
        <svg viewBox="0 0 45 45" className={className}>
          <g fill={isWhite ? "#ffffff" : "#262421"} stroke={isWhite ? "#111111" : "#151515"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M 22.5,11.63 L 22.5,6" stroke={isWhite ? "#111" : "#fff"} strokeWidth="1.5" />
            <path d="M 20,8 L 25,8" stroke={isWhite ? "#111" : "#fff"} strokeWidth="1.5" />
